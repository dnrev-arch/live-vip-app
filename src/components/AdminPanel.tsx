...
export default function AdminPanel({ streams, onUpdateStreams, onClose }: AdminPanelProps) {
  ...
  const categories = ['Jogos', 'Música', 'Esportes', 'Entretenimento', 'Fitness', 'Lifestyle'];
  ...
  const handleAddStream = () => {
    if (newStream.title && newStream.thumbnail && newStream.streamerName) {
      const stream: LiveStream = {
        ...
        viewerCount: newStream.viewerCount || 1000,
        isLive: true,
        streamerName: newStream.streamerName || '',
        streamerAvatar: newStream.streamerAvatar || 'https://i.pravatar.cc/150?img=1',
      ...
      <div className="min-h-screen p-4">
        <div className="bg-gray-900 rounded-2xl max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-700">
            <h2 className="text-2xl font-bold">Painel Administrativo - Gerenciar Lives</h2>
            <button
              onClick={onClose}
              ...
              <div className="bg-gray-800 rounded-lg p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    ...
                    className="bg-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:outline-none"
                  />
                  <input
                    type="text"
                  ...
                  <input
                    ...
                    onChange={(e) => setNewStream(prev => ({ ...prev, viewerCount: parseInt(e.target.value) || 1000 }))}
                    className="bg-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:outline-none"
                  />
                  <select
                    value={newStream.category}
                    onChange={(e) => setNewStream(prev => ({ ...prev, category: e.target.value }))}
                    className="bg-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-purple-500 focus:outline-none"
                  >
                    {categories.map(cat => (
            ...
            <div className="space-y-4">
              ...
              {streams.length === 0 ? (
                <div className="text-center py-8 bg-gray-800 rounded-lg">
                  <p className="text-gray-400">Nenhuma live cadastrada</p>
                </div>
              ) : (
                streams.map((stream) => (
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <input
                            ...
                            className="bg-gray-700 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-purple-500 focus:outline-none"
                          />
                          <input
                            type="text"
                        ...
                        <div className="flex items-center space-x-4">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              target.src = 'data:image/svg+xml;base64,';
                            }}
                          />
                          <div>
                            ...
                            <div className="flex items-center space-x-4 mt-1">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <input
                                  ...
                                  className="bg-gray-700 rounded px-2 py-1 text-sm w-20 text-white focus:ring-1 focus:ring-purple-500 focus:outline-none"
                                />
                              </div>
                            </div>
                          </div>
